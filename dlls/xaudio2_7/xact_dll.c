...
#if XACT3_VER == 0
IXAudio2Impl *impl_from_IXAudio20(IXAudio20 *iface)
{
    return CONTAINING_RECORD(iface, IXAudio2Impl, IXAudio20_iface);
}
#elif XACT3_VER <= 2
IXAudio2Impl *impl_from_IXAudio22(IXAudio22 *iface)
{
    return CONTAINING_RECORD(iface, IXAudio2Impl, IXAudio22_iface);
}
#elif XACT3_VER <= 3
IXAudio2Impl *impl_from_IXAudio23(IXAudio23 *iface)
{
    return CONTAINING_RECORD(iface, IXAudio2Impl, IXAudio23_iface);
}
#else
IXAudio2Impl *impl_from_IXAudio27(IXAudio27 *iface)
{
