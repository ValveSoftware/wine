...
__ASM_GLOBAL_FUNC(call_dll_entry_point,
                  ...
                  "ret" )
#elif defined(__x86_64__)
extern BOOL WINAPI call_dll_entry_point( DLLENTRYPROC proc, void *module, UINT reason, void *reserved );
...
__ASM_GLOBAL_FUNC(call_dll_entry_point,
                  ...
                  "ret" )
#else
static inline BOOL WINAPI call_dll_entry_point( DLLENTRYPROC proc, void *module,
