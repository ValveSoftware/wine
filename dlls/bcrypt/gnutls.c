...
static NTSTATUS CDECL key_asymmetric_encrypt( struct key *key, UCHAR *input, ULONG input_len,
        UCHAR *output, ULONG output_len, ULONG *ret_len, void *padding, ULONG flags )
{
