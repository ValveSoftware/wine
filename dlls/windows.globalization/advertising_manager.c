...
static inline struct advertising_manager_factory *impl_from_IActivationFactory( IActivationFactory *iface )
{
    return CONTAINING_RECORD( iface, struct advertising_manager_factory, IActivationFactory_iface );
}

static HRESULT WINAPI activation_factory_QueryInterface( IActivationFactory *iface, REFIID iid, void **out )
{
    struct advertising_manager_factory *impl = impl_from_IActivationFactory( iface );
    ...
    {
        IUnknown_AddRef(iface);
        *out = &impl->IAdvertisingManagerStatics_iface;
        return S_OK;
    }
...
DEFINE_IINSPECTABLE( statics, IAdvertisingManagerStatics, struct advertising_manager_factory, IActivationFactory_iface )
...
static struct advertising_manager_factory advertising_manager_factory =
{
...
IInspectable *system_user_profile_advertising_manager_factory = (IInspectable *)&advertising_manager_factory.IActivationFactory_iface;
