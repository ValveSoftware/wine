...
#undef LOAD_FUNCPTR
    ...
    if (!(pgnutls_alpn_set_protocols = wine_dlsym(libgnutls_handle, "gnutls_alpn_set_protocols", NULL, 0)))
    {
        WARN("gnutls_alpn_set_protocols not found\n");
        pgnutls_alpn_set_protocols = compat_gnutls_alpn_set_protocols;
    }
    if (!(pgnutls_alpn_get_selected_protocol = wine_dlsym(libgnutls_handle, "gnutls_alpn_get_selected_protocol", NULL, 0)))
    {
