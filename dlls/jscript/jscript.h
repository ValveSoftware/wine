...
HRESULT gc_run(script_ctx_t*,BOOL) DECLSPEC_HIDDEN;
...
void init_cc_api(IDispatch*) DECLSPEC_HIDDEN;
...
HRESULT create_proxy_constructor(IDispatch*,const char*,jsdisp_t*,jsdisp_t**) DECLSPEC_HIDDEN;
