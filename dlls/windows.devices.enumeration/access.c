...
static ULONG WINAPI dai_AddRef( IDeviceAccessInformation *iface )
{
    struct device_access_information *impl = impl_from_IDeviceAccessInformation( iface );
...
static ULONG WINAPI dai_Release( IDeviceAccessInformation *iface )
{
    struct device_access_information *impl = impl_from_IDeviceAccessInformation( iface );
...
static HRESULT WINAPI dai_GetIids( IDeviceAccessInformation *iface, ULONG *iid_count, IID **iids )
{
    FIXME( "iface %p, iid_count %p, iids %p stub!\n", iface, iid_count, iids );
    return E_NOTIMPL;
}

static HRESULT WINAPI dai_GetRuntimeClassName( IDeviceAccessInformation *iface, HSTRING *class_name )
{
...
static HRESULT WINAPI dai_GetTrustLevel( IDeviceAccessInformation *iface, TrustLevel *trust_level )
{
    FIXME( "iface %p, trust_level %p stub!\n", iface, trust_level );
    return E_NOTIMPL;
}

static HRESULT WINAPI dai_add_AccessChanged(
...
static HRESULT WINAPI dai_remove_AccessChanged( IDeviceAccessInformation *iface, EventRegistrationToken cookie )
{
...
static HRESULT WINAPI dai_CurrentStatus( IDeviceAccessInformation *iface, enum DeviceAccessStatus *status)
{
...
static const struct IDeviceAccessInformationVtbl device_access_information_vtbl =
{
    ...
    dai_GetIids,
    dai_GetRuntimeClassName,
    dai_GetTrustLevel,
    /* IDeviceAccessInformation methods */
    dai_add_AccessChanged,
    dai_remove_AccessChanged,
    dai_CurrentStatus,
};
