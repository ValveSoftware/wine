                                            ...
                                            struct fs_hack_fbo_attachments_config *config )
{
    ...
    if (attribs->srgb) config->color_internalformat = attribs->alpha_size ? GL_SRGB8_ALPHA8 : GL_SRGB8;
    else config->color_internalformat = attribs->alpha_size ? GL_RGBA8 : GL_RGB8;
...
static void fs_hack_setup_context( struct wgl_context *ctx, struct gl_drawable *gl )
{
    ...
    if (ctx->fs_hack)
    {
        ...
        if (!gl->fs_hack_context_set_up) opengl_funcs.gl.p_glClear( GL_COLOR_BUFFER_BIT );
...
static void fs_hack_blit_framebuffer( struct gl_drawable *gl, GLenum draw_buffer )
{
    ...
    opengl_funcs.gl.p_glClearColor( prev_clear_color[0], prev_clear_color[1], prev_clear_color[2],
                                    prev_clear_color[3] );
    ...
    {
        opengl_funcs.gl.p_glScissor( prev_scissor[0], prev_scissor[1], prev_scissor[2], prev_scissor[3] );
    }
