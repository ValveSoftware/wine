...
#define RENDER_CALL_DISPLAY_WIDTH ((RENDERER_CALL_DYNAMIC << 48) | 1)
#define RENDER_CALL_DISPLAY_HEIGHT ((RENDERER_CALL_DYNAMIC << 48) | 2)
#define RENDER_CALL_DEST_POS_X ((RENDERER_CALL_DYNAMIC << 48) | 3)
#define RENDER_CALL_DEST_POS_Y ((RENDERER_CALL_DYNAMIC << 48) | 4)
#define RENDER_CALL_DRAIN_HWND ((RENDERER_CALL_DYNAMIC << 48) | 5)

static ULONG64 renderer_call_get_expected_value(ULONG64 val)
{
    MONITORINFO info = { .cbSize = sizeof(info) };
    unsigned int screen_cx, screen_cy;
...
static void test_implicit_fullscreen_support(void)
{
    ...
    static const struct expected_renderer_call set_fullscreen_seq[] =
    {
        ...
        {{"test_window_put_Owner"}},
        {{"overlay_GetWindowHandle"}},
        {{"test_window_SetWindowPosition", {0, 0, RENDER_CALL_DISPLAY_WIDTH, RENDER_CALL_DISPLAY_HEIGHT}}},
        {{"test_window_get_MessageDrain"}},
    ...
    todo_wine ok(hr == VFW_E_IN_FULLSCREEN_MODE, "got %#lx.\n", hr);
    todo_wine check_renderer_calls(empty_seq);
    reset_renderer_calls();
