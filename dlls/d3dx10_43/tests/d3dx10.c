...
static void test_get_image_info(void)
{
    ...
    todo_wine check_dds_dx10_format_unsupported(DXGI_FORMAT_B5G6R5_UNORM, E_FAIL);
    todo_wine check_dds_dx10_format_unsupported(DXGI_FORMAT_B5G5R5A1_UNORM, E_FAIL);
    /* Formats that are newer than d3d10. */
    todo_wine check_dds_dx10_format_unsupported(DXGI_FORMAT_BC6H_UF16, E_FAIL);
    todo_wine check_dds_dx10_format_unsupported(DXGI_FORMAT_BC6H_SF16, E_FAIL);
    todo_wine check_dds_dx10_format_unsupported(DXGI_FORMAT_BC7_UNORM, E_FAIL);
    todo_wine check_dds_dx10_format_unsupported(DXGI_FORMAT_B4G4R4A4_UNORM, E_FAIL);
