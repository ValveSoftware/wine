...
pkgdatadir = $(datadir)/goliath
pkgincludedir = $(includedir)/goliath
pkglibdir = $(libdir)/goliath
pkglibexecdir = $(libexecdir)/goliath
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	AUTHORS COPYING.LIB README.md tools/compile tools/config.guess \
...
ATL_DEPS_CFLAGS = 
ATL_DEPS_LIBS = 
AUTOCONF = ${SHELL} '/workspaces/Goliath/tools/missing' autoconf
AUTOHEADER = ${SHELL} '/workspaces/Goliath/tools/missing' autoheader
AUTOMAKE = ${SHELL} '/workspaces/Goliath/tools/missing' automake-1.16
AWK = gawk
BISON = bison
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} '/workspaces/Goliath/tools/missing' makeinfo
MANIFEST_TOOL = :
...
OTOOL64 = 
PACKAGE = goliath
PACKAGE_BUGREPORT = goliath-devel@example.org
PACKAGE_NAME = Goliath
PACKAGE_STRING = Goliath 1.0-beta
PACKAGE_TARNAME = goliath
PACKAGE_URL = https://github.com/goliath-project/goliath
...
XML_LIBS = -lxml2 
abs_builddir = /workspaces/Goliath
abs_srcdir = /workspaces/Goliath
abs_top_builddir = /workspaces/Goliath
abs_top_srcdir = /workspaces/Goliath
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /workspaces/Goliath/tools/install-sh
